...
import { lprInstance, pvInstance } from '../../../util/instances';
...
const PVScreen = () => {
	...
	const { PVScreen: strings } = useMessage();
	const auth = useAuth();
	...
	const handleContinue = useCallback(async () => {
		...
		try {
			...
			const res = await pvInstance(authRef.current)
